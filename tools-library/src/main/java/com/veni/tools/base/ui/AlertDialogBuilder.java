...
public class AlertDialogBuilder {
    ...
    public void show() {
        if (dialog != null) {
            ...
            if (canceltime != 0) {
                VnUtils.delayToDo(canceltime, new OnDelayListener() {
                    @Override
    ...
    private View getDefault_Dialog() {
        View mDialogView = View.inflate(context, R.layout.v_dialog_default, null);
    ...
    private View getLoading_Dialog() {
        View loadingdialog = View.inflate(context, R.layout.v_dialog_loading, null);
