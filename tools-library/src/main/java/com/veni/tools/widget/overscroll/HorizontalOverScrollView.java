...
public class HorizontalOverScrollView extends HorizontalScrollView implements OverScrollingView,
    ...
    private final HorizontalOverFlyingDetector mOverFlyingDetector;
    ...
    public HorizontalOverScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mOverFlyingDetector = new HorizontalOverFlyingDetector();
    ...
    protected class HorizontalOverFlyingDetector extends OverFlyingDetector {
        @SuppressWarnings("WeakerAccess")
        public HorizontalOverFlyingDetector() {
