package com.veni.tools.widget.swipemenu;
...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //LogUtils.dTag(TAG, "onMeasure() called with: " + "widthMeasureSpec = [" + widthMeasureSpec + "], heightMeasureSpec = [" + heightMeasureSpec + "]");
        ...
        //LogUtils.dTag(TAG, "onMeasure() called with: " + "mRightMenuWidths = [" + mRightMenuWidths);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //LogUtils.dTag(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        //LogUtils.dTag(TAG, "onInterceptTouchEvent() called with: ev = [" + ev + "]");
    ...
    public void smoothExpand() {
        //LogUtils.dTag(TAG, "smoothExpand() called" + this);
    ...
    public void smoothClose() {
        //LogUtils.dTag(TAG, "smoothClose() called" + this);
