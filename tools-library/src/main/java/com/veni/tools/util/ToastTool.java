...
public class ToastTool {
    ...
    public static void normal(@NonNull String message) {
        normal(VnUtils.getContext(), message).show();
    }
    ...
    public static void info(@NonNull String message) {
        info(VnUtils.getContext(), message).show();
    }
    ...
    public static void success(@NonNull String message) {
        success(VnUtils.getContext(), message).show();
    }
    ...
    public static void error(@NonNull String message) {
        error(VnUtils.getContext(), message).show();
    }
    ...
    public static void warning(@NonNull String message) {
        warning(VnUtils.getContext(), message).show();
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), getDrawable(context, R.mipmap.ic_error_outline_white_48dp),
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), getDrawable(context, R.mipmap.ic_info_outline_white_48dp),
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), getDrawable(context, R.mipmap.ic_check_white_48dp),
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), getDrawable(context, R.mipmap.ic_clear_white_48dp),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        currentToast = Toast.makeText(context, "", Toast.LENGTH_SHORT);
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.v_toast_layout, null);
...
//        final NinePatchDrawable toastDrawable = (NinePatchDrawable) getDrawable(context, R.mipmap.toast_frame);
    ...
    public static void showToast(@NonNull String msg) {
        showToast(VnUtils.getContext(), msg, Toast.LENGTH_SHORT);
    }

    public static void showToast(@StringRes int resId) {
        showToast(VnUtils.getContext().getString(resId));
    }
