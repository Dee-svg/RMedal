...
package com.name.rmedal.ui.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        maskColor = ContextCompat.getColor(getContext(), R.color.alpha_30_black);
        resultColor = ContextCompat.getColor(getContext(), R.color.black);
        resultPointColor = ContextCompat.getColor(getContext(), R.color.colorAccent);
