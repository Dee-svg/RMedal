...
package com.name.rmedal.ui.zxing.camera;
...
import com.name.rmedal.ui.zxing.android.CaptureActivityHandler;
...
//    }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            ...
            int actionbarHeight = context.getResources().getDimensionPixelSize(R.dimen.hight_48);
